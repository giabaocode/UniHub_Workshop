...
const StudentHome = () => {
  ...
  // --- LOGIC LỌC VÀ PHÂN TRANG DỮ LIỆU ---
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 overflow-hidden relative">
      ...
      {/* Hero Section đã được tách Component */}
        ...
        <section id="workshop-list" className="scroll-mt-24 mb-20">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            <div>
              ...
              <p className="text-gray-500 text-lg">Khám phá và đăng ký ngay các workshop hữu ích</p>
            </div>
          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20 text-blue-500">
              ...
              <p className="font-medium text-gray-500">Đang tải dữ liệu từ kho hệ thống...</p>
            </div>
