    ...
    const fetchDetail = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          price: data.price || "",
          registrationDeadlineDate: data.registrationDeadline
            ? data.registrationDeadline.split("T")[0]
            : "",
          registrationDeadlineTime:
            data.registrationDeadline && data.registrationDeadline.includes("T")
              ? data.registrationDeadline.split("T")[1]
              : "",
          description: data.description || "",
          coverImageUrl: data.coverImageUrl || "",
          pdfUrl: data.pdfUrl || "",
          aiSummary: data.aiSummary || "",
          roomMapUrl: data.roomMapUrl || "",
        });
      } catch (error) {
