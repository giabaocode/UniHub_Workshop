  ...
  useEffect(() => {
    const updateGoogleButtonWidth = () => {
      if (googleButtonRef.current) {
        setGoogleButtonWidth(Math.floor(googleButtonRef.current.getBoundingClientRect().width));
      }
    };
          ...
          <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in slide-in-from-left-4 duration-500">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full h-10 bg-[#24292F] text-white font-bold text-sm rounded border border-[#24292F] shadow-sm hover:bg-gray-800 transition-all flex items-center justify-center gap-2"
              >
